    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                btn=[
                        [InlineKeyboardButton(text=f"⇱🤷‍♀️ Take Action 🗃️⇲", url=f'https://t.me/{BOT_USERNAME}')],
                        [InlineKeyboardButton(text=f"🗑 Delete log ❌", callback_data=f'close_data')],
                    ]
                reply_markup=InlineKeyboardMarkup(btn)
                footer_credit = "🦋<a href='https://telegram.me/Srikanth_Official_Bot'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://telegram.me/Srikanth_Official_Bot'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
                ...
                print(error)
                await message.reply_text(f'Error Occured Baby 😀\n\n{error}')
    else:
        return
